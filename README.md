...
Once the web GUI restarts, log in as an administrator. You will see a new "Network Provisioner" menu item under Interfaces, allowing you to deploy new network rapidly.
